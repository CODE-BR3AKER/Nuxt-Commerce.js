      ...
      <template v-slot:cart>
        ...
        >
          ...
          >
            ...
            <circle cx="21.5" cy="2.5" r="1.5" fill="#C40000"/>
          </svg>
        </span>
        <span
          class="pl-3 inline-block no-underline hover:text-black"
...
export default {
  ...
  mounted(){
    const grayProd = ["Book","Poster","Keyboard","Lounge chair","Mouse"];
    if( grayProd.includes(this.product.name)){
      document.querySelector(".product__container").classList.add("gray-2");
    }else{
      document.querySelector(".product__container").classList.add("gray-1");
    }
  },
  computed: {
    ...mapGetters({
